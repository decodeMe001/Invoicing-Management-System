			...
			<div class="row">
				...
				<tr>
				  <td><span id="sr_no"><?=$m ?></span></td>
					<td>
						<select name="category[]" id="category<?=$m ?>" class="form-control input-sm category" >
					...
					<td>
						<input type="number" name="unit_price[]" id="unit_price<?=$m ?>" placeholder="&#8358;" data-srno="<?=$m ?>" class="form-control input-sm unit_price" value="<?=$sub_row['unit_price']?>" required readonly />
					</td>
					<td>
						<input type="number" name="selling_price[]" id="selling_price<?=$m ?>" placeholder="&#8358;" data-srno="<?=$m ?>" class="form-control input-sm selling_price" value="<?=$sub_row['selling_price']?>" required readonly />
					</td>
					<td>
						<input type="number" name="total_cost_price[]" id="total_cost_price<?=$m ?>" placeholder="&#8358;" data-srno="<?=$m ?>" class="form-control input-sm total_cost_price" required />
					</td>
					<td>
						<input type="number" name="total_selling_price[]" id="total_selling_price<?=$m ?>" placeholder="&#8358;" data-srno="<?=$m ?>" class="form-control input-sm total_selling_price" required />

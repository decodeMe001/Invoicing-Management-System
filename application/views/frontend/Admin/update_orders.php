	    ...
	    <table class="table table-bordered">
				...
				<td colspan="2">
				  ...
				  <table id="invoice-item-table" class="table table-bordered">
						...
						<tr>
						  ...
						  <td><input type="number" disabled name="order_item_quantity[]" id="order_item_quantity<?php echo $m; ?>" data-srno="<?php echo $m; ?>" class="form-control input-sm order_item_quantity" value = "<?php echo $sub_row["order_item_quantity"]?>"/></td>
		  ...
		  <tr>
			<td colspan="2" align="center">
			  ...
			  <input type="submit" name="update_invoice" id="create_invoice" class="btn btn-success btn-md fa fa-plus" value="Update" />
			</td>
		  </tr>
	  </table>
	</div>

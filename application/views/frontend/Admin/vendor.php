...
<div class="container-fluid">
	<form method="post" id="invoice_form" action="<?php echo base_url();?>admin/vendor/create">
				...
				<tr>
					<td colspan="2">
						...
						<div class="row">
							<div class="col-md-5">
								<br /><b>Debt:</b><br />
								<input type="number" name="debt" placeholder="Enter vendor Debt" class="form-control input-sm" value="0" required />		
							</div>
							<div class="col-md-5">
								<br/><b>Credit Limit:</b><br/>
								<input type="number" name="credit_limit" placeholder="Enter vendor credit limit" class="form-control input-sm" value="0" required />									  
							</div>
						</div>
					</td>
				</tr>
		...
		<table class="table table-bordered table-striped display" id="data-table" style="width:100%;">
		  <thead>
			...
			if($total_vendor_rows > 0)
			{
				...
				<td>
				<a href="vendor/delete/<?=$row['id'] ?>" class="delete-vendor btn btn-danger btn-sm">
      ...
      $(document).ready(function(){
		...
		$(document).on('click', '.delete-vendor', function(){
			...
			if(confirm("Are you sure you want to remove this?"))
			  {
				window.location.href = base_url("admin/vendor");
			  }
			  else
			  {
				return false;

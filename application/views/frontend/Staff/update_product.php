...
?>
   ...
   <form role="form" class="form-horizontal" action="<?= base_url(); ?>admin/product/update/<?=$row['id']; ?>" method="post" enctype="multipart/form-data">
...
?>
   <form role="form" class="form-horizontal" action="<?php echo base_url(); ?>staff/product/update/<?=$row['id']; ?>" method="post" enctype="multipart/form-data">
		<div class="form-group">
		  <div class="row">
			<label for="field-1" class="col-md-4 control-label">ID:</label>
				<div class="col-md-8">

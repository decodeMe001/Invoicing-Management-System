			...
			<div class="row">
				...
				<tr>
				  <td><span id="sr_no"><?php echo $m; ?></span></td>
					...
					<td>
						<input type="text" name="item_name[]" id="item_name<?php echo $m; ?>" data-srno="<?=$m; ?>" value="<?=$sub_row["item_name"];?>" class="form-control input-sm item_name" required />
					</td>
					<td>
						<input type="number" name="order_item_quantity[]" id="order_item_quantity<?php echo $m; ?>" data-srno="<?=$m; ?>" value="<?=$sub_row["order_item_quantity"];?>" class="form-control input-sm order_item_quantity" required />
					</td>
					<td>
						<input type="number" name="unit_price[]" id="unit_price<?php echo $m; ?>" placeholder="&#8358;" data-srno="<?=$m; ?>" class="form-control input-sm unit_price" value="<?=$sub_row['unit_price']?>" required />
					</td>
					<td>
						<input type="number" name="selling_price[]" id="selling_price<?php echo $m; ?>" placeholder="&#8358;" data-srno="<?=$m; ?>" class="form-control input-sm selling_price" value="<?=$sub_row['selling_price']?>" required />
					</td>
					<td>
						<input type="number" name="total_cost_price[]" id="total_cost_price<?php echo $m; ?>" placeholder="&#8358;" data-srno="<?=$m; ?>" class="form-control input-sm total_cost_price" value="<?=$sub_row['total_cost_price']?>" required />
					</td>
					<td>
						<input type="number" name="total_selling_price[]" id="total_selling_price<?php echo $m; ?>" placeholder="&#8358;" data-srno="<?=$m; ?>" class="form-control input-sm total_selling_price" value="<?=$sub_row['total_selling_price']?>" required />
